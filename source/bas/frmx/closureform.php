...
*/
class bas_frmx_closureform extends bas_html_page{
	public $frames= array();
	public $toolbar;
	public $buttonbar;
	...
	public function OnLoad($permission=array('permission'=>'allow')){
		...
		$this->addjqueryui();
		$this->addScript("script/closure/closure-core.js");
		$this->addScript("script/closure/closure-form.js");
		$this->addScript("script/closure/closure-frame.js");
		$this->addScript("script/closure/closure-listframe.js");
	}
